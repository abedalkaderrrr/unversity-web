          ...
          <div class="container text-right style-container"  >
              <div class="tan" >
                ...
                @if ($errors->any())
                 ...
                 @endif
                  <h1>  إضافة بيانات قسم </h1>
                  <form action="{{route('category.add')}}" method="POST">
                    @csrf
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                          <input type="text" id="n" name="catId" placeholder="number of the department..">
                      </div>
                      <div class="col-md-3"  >
                  ...
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                          <input type="text" id="ka" name="name" placeholder="name of the department..">
                      </div>
                      <div class="col-md-3"  >
                  ...
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                        <input type="text" id="year" name="year" placeholder="name of the year..">
                  ...
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                        <input type="text" id="sh" name="section" placeholder="name of the section..">

                      </div>
                      <div class="col-md-3"  >
                          <label style="margin:auto 10px;" for="sh"> الشعبة </label>
                      </div>
                      <div class="col-md-1"></div>
                  </div>
                  <div class="row">
