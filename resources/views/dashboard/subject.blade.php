           ...
           <h3 class="text-right">{{$user->name}}</h3>
               <table class="table">
                   ...
                   <tbody >
                     ...
                     <tr>
                      <tr>
                        <td><form action="{{route('teacher.deleteMatrial',['id'=>$user->id,'matrial'=>$item->id])}}" method="POST">
                         @csrf
                         @method('DELETE')
                  ...
                  <table class="table">
                   ...
                   <tbody id="myTable">
                    ...
                    <tr>
                     <td><form action="{{route('teacher.addMatrial',['id'=>$user->id,'matrial'=>$item->id])}}" method="POST">
                      @csrf
