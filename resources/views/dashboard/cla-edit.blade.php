              ...
              <div class="tan" >
                  ...
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                          <input type="text" id="ka" name="ka" placeholder="name..">
                      </div>
                      <div class="col-md-3"  >
                          <label for="ka"> إسم القاعة </label>
                      </div>
                      <div class="col-md-1"></div>
                  </div>
                  <div class="row">
                      <div class="col-md-6 col-md-offset-2" >
                          <input type="text" id="capasity" name="capasity" placeholder="capasity..">
                      </div>
                      <div class="col-md-3"  >
                          <label for="capasity"> سعة القاعة </label>
                      </div>
                      <div class="col-md-1"></div>
                  </div>
                  <div class="row">
