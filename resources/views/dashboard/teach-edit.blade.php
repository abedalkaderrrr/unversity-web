    ...
    <div class="wrapper">
        ...
        <div class="add">
            <div class="container text-right style-container"  >
              <form action="{{route('teacher.edit',['id'=>$teacher->id])}}" method="POST">
                @csrf
                @method('PUT')
                <div class="tan" >
                  ...
                  @if ($errors->any())
                   ...
                   @endif
                    <h1>  تعديل بيانات إستاذ </h1>
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                            <input type="text" id="name" name="name" placeholder=" name.." value="{{$teacher->name}}">
                        </div>
                        <div class="col-md-3"  >
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                            <input type="email" id="email" name="email" placeholder="email.." value="{{$teacher->email}}">
                        </div>
                        <div class="col-md-3"  >
