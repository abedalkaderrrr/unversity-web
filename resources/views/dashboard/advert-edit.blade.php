        ...
        <div class="add">
            <div class="container text-right style-container"  >
              ...
              @if ($errors->any())
               ...
               @endif
                    <h1> تعديل إعلان </h1>
                    <form action="{{route('advertisment.edit',['id'=>$advertisment->id])}}" method="POST">
                      @csrf
                      @method('PUT')
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                            <input type="text" id="title" name="title" placeholder="title.." value="{{$advertisment->title}}">
                        </div>
                        <div class="col-md-3"  >
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                            <textarea id="conten" name="content" placeholder="conten.." >{{$advertisment->content}}</textarea>
                        </div>
                        <div class="col-md-3"  >
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                          <input type="text" id="sha" name="slice" placeholder="slice.." value="{{$advertisment->slice}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2" >
                            <input type="date" name="period" class="today" value="{{$advertisment->period->format('Y-m-d')}}">
                        </div>
                        <div class="col-md-3"  >
                            <label style="margin:auto 10px;" for="today"> المدة </label>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row">
