               ...
               @endif
                 ...
                 <div class="row">
                     <div class="col-md-6 col-md-offset-2" >
                         <input type="text" id="n" name="catId" placeholder="number of the department.." value="{{$category->catId}}">
                     </div>
                     <div class="col-md-3"  >
                         <label for="ka"> رقم القسم </label>
                     </div>
                     <div class="col-md-1"></div>
                 </div>
                 <div class="row">
                     <div class="col-md-6 col-md-offset-2" >
                         <input type="text" id="ka" name="name" placeholder="name of the department.." value='{{$category->name}}'>
                     </div>
                     <div class="col-md-3"  >
                         <label for="ka"> اسم القسم </label>
                     </div>
                     <div class="col-md-1"></div>
                 </div>
                 <div class="row">
                     <div class="col-md-6 col-md-offset-2" >
                      <input type="text" id="section" name="year" placeholder="number of year.."  value='{{$category->year}}'>
                 ...
                 <div class="row">
                     <div class="col-md-6 col-md-offset-2" >
                      <input type="text" id="section" name="section" placeholder="number of section.."  value='{{$category->section}}'>
                    </div>
                     <div class="col-md-3"  >
