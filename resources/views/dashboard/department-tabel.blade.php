      ...
      <div class="container text-center part tan-tabel">
          ...
          <table class="table">
              ...
              <tfoot >
                <tr>
                  <td>
                    <a href="{{route('categoryPageAdd')}}" type="button" class="btn btn-primary foot"  style="margin-right :5px ;"> إضافة</a>
                    <a  type="button" class="btn btn-info foot "> تصدير </a>
