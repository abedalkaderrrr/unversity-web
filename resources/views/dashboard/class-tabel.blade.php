          ...
          <div class="container text-center part tan-tabel">
              ...
              <table class="table">
                  ...
                  <tbody id="myTable">
                      ...
                      <tr>
                        <td><form style="display:inline" action="{{route('room.delete',['id' => $room->id])}}" method="POST">
                          @csrf
                          @method('DELETE')
                  ...
                  <tfoot >
                    <tr>
                      <td>
                        <a href="{{route('roomPageAdd')}}" type="button" class="btn btn-primary"  style="margin-right :5px ;">إضافة</a>
